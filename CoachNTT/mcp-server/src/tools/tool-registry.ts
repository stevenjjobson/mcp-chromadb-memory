...
export class ToolRegistry {
  ...
  getTools(): ToolDefinition[] {
    ...
    // Add audio synthesis tools if available
    if (this.services.audioSynthesisService) {
      tools.push(...this.getAudioTools());
    }
  ...
  private getAudioTools(): ToolDefinition[] {
    return [
      {
      ...
      {
        name: 'check_audio_quota',
        description: 'Check remaining audio synthesis quota',
        inputSchema: {
          type: 'object',
          properties: {}
        },
